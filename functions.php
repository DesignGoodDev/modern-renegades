...
if ( ! function_exists( 'modern_renegades_setup' ) ) :
	...
	function modern_renegades_setup() {
		 ...
		 * If you're building a theme based on Modern Renegades, use a find and replace
		 * to change 'modern-renegades' to the name of your theme in all the template files.
		 */
...
function modern_renegades_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'modern_renegades_content_width', 640 );
}
 ...
 */
function modern_renegades_scripts() {
...
add_action( 'wp_enqueue_scripts', 'modern_renegades_scripts' );
